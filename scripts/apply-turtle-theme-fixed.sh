...
# Turtle Enclosure System - Theme Application Script (Fixed)
...
cp /home/shrimp/turt3/themes/turtle-theme.yaml "$HA_CONFIG_DIR/themes/"

# Set proper permissions for theme
chown 1000:1000 "$HA_CONFIG_DIR/themes/turtle-theme.yaml"
chmod 644 "$HA_CONFIG_DIR/themes/turtle-theme.yaml"

# Copy dashboard configuration
print_status "Installing dashboard configuration..."
cp /home/shrimp/turt3/home-assistant/ui-lovelace.yaml "$HA_CONFIG_DIR/ui-lovelace.yaml"

# Set proper permissions for dashboard
chown 1000:1000 "$HA_CONFIG_DIR/ui-lovelace.yaml"
chmod 644 "$HA_CONFIG_DIR/ui-lovelace.yaml"
